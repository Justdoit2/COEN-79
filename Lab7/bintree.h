...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            inorder(node_ptr->left()); //go left
            f(node_ptr->data()); //print root
            inorder(node_ptr->right()); //go right
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
            l_ptr=tree_copy(root_ptr->left()); //add all of left
            r_ptr=tree_copy(root_ptr->right()); //add all of right
            return new binary_tree_node<Item>(root_ptr->data(),l_ptr,r_ptr); //return final
        }
    }
    ...
    // Library facilities used: cstdlib
    {
        if (node_ptr == NULL)
            ...
            // STUDENT WORK
            return (tree_size(node_ptr->left())+1 +tree_size(node_ptr->right()) );//count root, recurse treesize left/right
    }
}
