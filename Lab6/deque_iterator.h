...
namespace coen79_lab8
{
    ...
    public:
        ...
        deque_iterator& operator ++( ) // Prefix ++
        {
            ...
            {
                // STUDENT WORK...
                ++current_block_pointer; //increase block
                
                current_boundary=*current_block_pointer+(block_size-1);//set current_boundary to end of block
                cursor=*current_block_pointer; //set cursor to current_block_pointer
        ...
        deque_iterator operator ++(int) // Postfix ++
        {
            ...
            {
                // STUDENT WORK...
                ++current_block_pointer;//move ahead current_block_pointer
                current_boundary=*current_block_pointer+(block_size-1); //set cursor to new block
